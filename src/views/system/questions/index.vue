<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="题目 ID" prop="topicId">
        <el-input
    ...
    <el-table v-loading="loading" :data="questionsList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="题目 ID" align="center" prop="topicId"/>
      <el-table-column label="用户提交的答案" align="center" prop="userAnswer"/>
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$confirm('是否确认删除问卷答题编号为"' + ids + '"的数据项?', "警告", {
